...
namespace Project
{
    public partial class RecruiterReports : Form
    {
        public RecruiterReports()
        {
            InitializeComponent();
            reporting_1();
            reporting_2();
        ...
        {
            var adapter = new InterviewsPerCompanyTableAdapters.InterviewsPerCompanyTableAdapter();
            var table = new InterviewsPerCompany.InterviewsPerCompanyDataTable();
            adapter.Fill(table);

            ReportDataSource rds = new ReportDataSource("InterviewsPerCompanyDataSet", (DataTable)table);

            reportViewer1.LocalReport.ReportPath = "InterviewPerCompany.rdlc";
        ...
        {
            var adapter = new OfferToAcceptanceTableAdapters.OfferToAcceptanceTableAdapter();
            var table = new OfferToAcceptance.OfferToAcceptanceDataTable();
            adapter.Fill(table);

            ReportDataSource rds = new ReportDataSource("OfferToAcceptanceDataSet", (DataTable)table);

            reportViewer2.LocalReport.ReportPath = "OfferToAcceptance.rdlc";
        ...
        {
            var adapter = new RatingsForRecruitersTableAdapters.RatingsForRecruitersTableAdapter();
            var table = new RatingsForRecruiters.RatingsForRecruitersDataTable();
            adapter.Fill(table);

            ReportDataSource rds = new ReportDataSource("RatingsForRecruitersDataSet", (DataTable)table);

            reportViewer3.LocalReport.ReportPath = "RatingsForRecruiters.rdlc";
